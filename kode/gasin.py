...
if not selected_images:
    ...
    results = []  # List untuk menyimpan hasil dari setiap gambar
    ...
    for image_path in selected_images:
        ...
        # Menambahkan nama gambar ke hasil
        pivot_table['Image'] = os.path.basename(image_path)

        # Menyimpan hasil ke list
        results.append(pivot_table)

    # Membuat DataFrame dari semua hasil dan menyimpannya ke file CSV
