...
# Menghapus kolom 'Image' untuk analisis korelasi
...
plt.legend()
plt.savefig('/home/uddin/plots/distribusi_RGB.png')  # Save the plot to a file
...
plt.ylabel('Frekuensi')
plt.legend()
plt.savefig('/home/uddin/plots/distribusi_HSV.png')  # Save the plot to a file
plt.close()
...
plt.ylabel('Frekuensi')
plt.legend()
plt.savefig('/home/uddin/plots/distribusi_HSL.png')  # Save the plot to a file
plt.close()
...
plt.savefig('/home/uddin/plots/korelasi_matrix.png')  # Save the plot to a file
plt.close()
